...
async function main() {
  ...
  if (command === 'discover') { const productIds = productIdsArg(); const proposal = await discover(productIds ? { productIds } : {}); writeReport(proposal); console.error('DISCOVERY ONLY: no mappings applied; data.js and app.js were not modified.'); return; }
